...
arc_ks = k_fit_pch(data, ks = 2:4, check_installed = T,
                   ...
                   bootstrap_type = "m", seed = 2543, convex_hull = T,
...
arc_data2 = fit_pch_bootstrap(data, n = 50, sample_prop = 0.65, seed = 2543,
                           ...
                           delta = 0, convex_hull = T, conv_crit = 1e-4, type = "m")
...
** Faster version of randomisation that measure t-ratio alone
...
pch_rand_t = randomise_fit_pch(data, arc_data = arc_ks, n_rand = 1000,
                             ...
                             # don't stop computation if one iteration failed
